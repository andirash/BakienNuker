...
def setTitle(_str):
    system = os.name
    if system == 'nt':
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str} BakienNuker   |    Made by @andirashwtf    |    Tokens: [{counttokens}]")
    elif system == 'posix':
        sys.stdout.write(f"{_str}BakienNuker   |    Made by @andirashwtf    |    Tokens: [{counttokens}]")
    else:
        pass
