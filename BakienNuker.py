...
try:
    ...
    with open('data/logins.json', 'w') as f:
            print(f"\n[{g}#\x1b[95m\x1B[37m] Logging Into BakienHook-Nuker")
...
def spammer():
    ...
    Write.Print(f' > [m]\n', Colors.purple_to_blue, interval=0.000)
    Write.Print("════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════\n", Colors.purple_to_blue, interval=0.000)
    Write.Print(f' > [made in UKRAINE]\n', Colors.purple_to_blue, interval=0.000)
    Write.Print(f' > [Version: 0.0.1]\n', Colors.purple_to_blue, interval=0.000)  
    Write.Print(f' > [https://discord.gg/afffQb3awp - Join us]\n', Colors.purple_to_blue, interval=0.000)    
    Write.Print("════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════", Colors.purple_to_blue, interval=0.000)
...
[\x1b[95m1\x1b[95m\x1B[37m] Join us
[\x1b[95m2\x1b[95m\x1B[37m] Exit
  
[\x1b[95m>\x1b[95m\x1B[37m] Choice?: """)

        if gh in ['01','1']:
            webbrowser.open('https://discord.gg/afffQb3awp')
        elif gh in ['02','2']:
            exit = spammer()
        else:
         print('')
...
#   ABOUT
    if choice == '30':
        Spinner()
        setTitle(f"About    |    ")
        Write.Print("\nHello, thanks for using BakienNuker\nBakienNuker in alpha test\nDiscord: https://discord.gg/afffQb3awp\nWebsite: WIP\n\n", Colors.purple_to_blue, interval=0.015)
